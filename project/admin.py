...
from .models import Project, ProjectSchemaLessData, ProjectAttachment, ProjectMember, ProjectTask
...
class ProjectMemberAdmin(admin.ModelAdmin):
    list_display = ['pk', 'project', 'member', 'member_username', 'member_fullname']
